            ...
            <div className="w-[50%] h-200 flex justify-center items-center flex-col gap-10">
                <div className="flex h-200 mt-40 flex-col gap-5">
                    ...
                    <div className={`min-h-15 w-110 flex flex-col gap-3 border-b transition-all duration-800 ease-out border-gray-300 ${plus1 ? "max-h-40" : "max-h-15"}`}>
                        ...
                        <p className={`text-[#6A7285] transition-opacity transition-transform duration-800 overflow-hidden ease-linear ${plus1 ? "opacity-100 translate-y-0 max-h-40 pb-5" : "opacity-0 translate-y-5 max-h-0 pb-0"}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                    </div>
                    <div className={`min-h-15 w-110 flex flex-col gap-3 border-b transition-all duration-800 ease-out border-gray-300 ${plus2 ? "max-h-40" : "max-h-15"}`}>
                        ...
                        <p className={`text-[#6A7285] transition-opacity transition-transform duration-800 overflow-hidden ease-linear ${plus2 ? "opacity-100 translate-y-0 max-h-40 pb-5" : "opacity-0 translate-y-5 max-h-0 pb-0"}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                    </div>
                    <div className={`min-h-15 w-110 flex flex-col gap-3 border-b transition-all duration-800 ease-out border-gray-300 ${plus3 ? "max-h-40" : "max-h-15"}`}>
                        ...
                        <p className={`text-[#6A7285] transition-opacity transition-transform duration-800 overflow-hidden ease-linear ${plus3 ? "opacity-100 translate-y-0 max-h-40 pb-5" : "opacity-0 translate-y-5 max-h-0 pb-0"}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                    </div>
                </div>
            </div>
