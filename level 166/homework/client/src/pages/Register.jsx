...
const Register = () => {
    ...
    return (
        <section className="mx-auto w-full max-w-md">
            <div className="rounded-3xl border border-white/70 bg-white/75 p-6 shadow-xl shadow-amber-100/80 backdrop-blur sm:p-8">
                <h1 className="text-2xl font-extrabold tracking-tight text-slate-900">Create Account</h1>
                <p className="mt-1 text-sm text-slate-500">Join and start conversations in seconds.</p>

                <form onSubmit={(e) => { handleSubmit(e, signUp); resetForm(); }} className="mt-6 space-y-4">
                    <div>
