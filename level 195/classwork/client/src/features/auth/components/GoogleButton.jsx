 ...
 * GoogleButton
 * ------------
 * "Continue with Google" — kicks off the OAuth redirect flow. The Google "G"
 * is an inline multi-color SVG (no asset/dependency). Label is localized.
 */
...
export function GoogleButton({ className }) {
