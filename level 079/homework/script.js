// 1) გააკეთეთ პროეტი, წამოიღეთ მონაცემები ამ ლინკიდან https://fakestoreapi.com/products, გამოიყენეთ fetch, async/await try/catch, ვისაც 
// არ გაქვთ დამატებული Add to cart და Delete from cart ფუნქციები, (დაამატეთ) დამატებული პროდუქტები კი შეინახეთ ლოკალურ ბაზაში 
// რადგან და - refresh - ებისას პროდუქტები არ გაქრეს, ასევე შეამოწმეთ თუ პროდუქტი უკვე არსებობს ერთი და იმავე id - ით alert - ის 
// სახით აცნობეთ რომ The product is already added to the cart ან კიდევ გაზარდეთ ამ პროდუქტის რაოდენობა ერთით
